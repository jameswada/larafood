...
@section('title', 'Permissões disponiveis ao Cargo'  )

@section('content_header')
   <ol class="breadcrumb">
      <li class="breadcrumb-item"> <a href="{{ route('admin.index')}}">Dashboard</a></li>
      <li class="breadcrumb-item active"> <a href="{{ route('roles.index')}}">Permissões disponiveis ao Cargo</a></li>
   </ol>

   <h8>Permissões disponiveis ao Cargo <small><strong>{{$role->name}}</strong></small></h8> 
@stop
